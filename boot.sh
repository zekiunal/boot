...
sudo echo [{"stack":"${STACK}","ip":"${SWARM_MASTER_IP}"}]  >> stack.json
sudo docker run -i --rm --name aws -v /home/core/.aws:/root/.aws cgswong/aws:aws s3 cp stack.json s3://bucket.ci.monapi.com/stack.json 
